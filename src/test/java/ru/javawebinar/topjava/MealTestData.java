...
public class MealTestData {
    ...
    public static final Meal meal8 = new Meal(LocalDateTime.of(2020, Month.JANUARY, 29, 10,0), "Завтрак Админа", 500);
    public static final Meal meal9 = new Meal(LocalDateTime.of(2020, Month.JANUARY, 29, 20,0), "Завтрак Админа", 1500);

    public static Meal getNewMeal() {
        return new Meal(LocalDateTime.of(2020, Month.JANUARY, 29, 13,0), "новая еда", 1000);
    }
